...
<!--                    <img src="public/img/main-img.png" alt="" class="img">-->
<!--                    <div class="container">-->
...
<!--                        MAGELLINE is a metasearch engine for flights, hotel bookings, tours/activities as well as other-->
<!--                        travel services, which can be searched by price and location. The brand was born in 2018.-->
<!--                        MAGELLINE operates the magelline.com website.-->
<!--                        Under the slogan, "Keep Traveling!" MAGELLINE has been endeavoring to provide travelers with the-->
<!--                        best travel deals and more distinguished services than any other OTA (Online Travel Agency) in-->
<!--                        the world.-->
<!--                    </div>-->
<!--                    <a class="arrow-link-btn" href="">-->
<!--                        Read MORE-->
<!--                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">-->
<!--                            <path d="M2 2L15 15M15 15H3.62471M15 15V3.62471" stroke="#FF6B00" stroke-width="3"-->
<!--                                  stroke-linecap="round" stroke-linejoin="round"/>-->
<!--                        </svg>-->
<!--                    </a>-->
<!--                </div>-->
<!--                <div class="about-us-img">-->
<!--                    <img src="public/img/about-us-img.png" alt="" class="img">-->
<!--                </div>-->
<!--            </div>-->
...
<!--                            <path d="M53 14L0.999998 14M53 14L40 0.999999M53 14L40 27" stroke="#FF6B00" stroke-width="2"-->
<!--                                  stroke-linecap="round" stroke-linejoin="round"/>-->
<!--                        </svg>-->
<!--                    </h2>-->
...
<!--                        Lorem ipsum dolor sit ametconsectetur adipiscing elit. Proin-->
<!--                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sagittis, est ut viverra-->
<!--                        eleifend, augue nunc vehicula erat, sit amet molestie orci purus vel erat...-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                        Lorem ipsum dolor sit ametconsectetur adipiscing elit. Proin-->
<!--                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin sagittis, est ut viverra-->
<!--                        eleifend, augue nunc vehicula erat, sit amet molestie orci purus vel erat. Maecenas vitae-->
<!--                        sagittis leo. Ut efficitur tristique ex a convallis. Pellentesque habitant morbi tristique-->
...
<!--                    <img src="public/img/location-icons.png" alt="" class="img">-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </section>-->
...
<!--                                <path d="M2 2L13 13M13 13H3.37476M13 13V3.37476" stroke="#FF6B00" stroke-width="3"-->
<!--                                      stroke-linecap="round" stroke-linejoin="round"/>-->
<!--                            </svg>-->
<!--                        </a>-->
<!--                    </div>-->
<!--                    <a href="" class="guidebook-card__item">-->
<!--                        <img class="img guidebook-card-img" src="public/img/guidebook-card-img.png" alt="">-->
...
<!--                        We build products and technology solutions that connect the dots and remove barriers to power-->
<!--                        more travel for everyone, everywhere.-->
<!--                        We build products and technology solutions that connect the dots and remove barriers to power-->
<!--                        more travel for everyone, everywhere.-->
<!--                        We build products and technology solutions that connect the dots and remove barriers to power-->
<!--                        more travel for everyone, everywhere.-->
...
<!--                            <img class="img" src="public/img/airlines-img.png" alt="">-->
<!--                        </div>-->
<!--                        <div class="company-row__item">-->
<!--                            <img class="img" src="public/img/airlines-img.png" alt="">-->
<!--                        </div>-->
...
<!--                                 xmlns="http://www.w3.org/2000/svg">-->
<!--                                <path d="M25 11.5V5.66667C25 4.429 24.4942 3.24194 23.5941 2.36676C22.694 1.4916 21.473 1 20.2 1H5.79999C4.52695 1 3.30605 1.4916 2.40588 2.36676C1.5057 3.24194 1 4.429 1 5.66667V17.3333C1 18.571 1.5057 19.7579 2.40588 20.6331C3.30605 21.5083 4.52695 22 5.79999 22H13"-->
<!--                                      stroke="#B6B6B6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>-->
<!--                                <path d="M23 4C16.6042 14.6717 8.39579 14.6617 2 4" stroke="#B6B6B6" stroke-width="2"-->
<!--                                      stroke-linecap="round" stroke-linejoin="round"/>-->
<!--                                <path d="M17 19H26" stroke="#52ABE5" stroke-width="2" stroke-linecap="round"-->
<!--                                      stroke-linejoin="round"/>-->
<!--                                <path d="M24 16L28 19L24 22" stroke="#52ABE5" stroke-width="2" stroke-linecap="round"-->
<!--                                      stroke-linejoin="round"/>-->
<!--                            </svg>-->
<!--                            info@magelline.com-->
<!--                        </a>-->
...
<!--                                <img src="public/img/linkedin.png" class="img" alt="">-->
<!--                            </a>-->
<!--                            <a href="https://www.linkedin.com/" class="footer-social-icons__link" target="_blank">-->
<!--                                <img src="public/img/instagram.png" class="img" alt="">-->
<!--                            </a>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                        <img src="public/img/applePay.png" alt="">-->
<!--                    </div>-->
<!--                    <div class="payment__item">-->
...
<!--        fetch('http://localhost:9000/?resource=user&action=login', {-->
<!--            method: 'POST',-->
<!--            headers: {-->
